...
<body>
    ...
    <nav class="navbar nav-tabs sticky-top nav-justified">
        <div class="container_fluid">

            <!-- ***** Logo ***** -->
            <a class="navbar-brand" href="#">
            <img src="assets/img/logo.png" alt="Logo" class="logo" style="width=2em; height=25em;">  Phi</a>
        ...
        <div class="container_fluid">
            ...
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="accessories.php">Accessories</a>
                </li>
                <li class="nav-item">
